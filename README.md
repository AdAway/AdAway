...
##Preview Build
For Android Nougat users, or users with bugs, please test out the preview build from http://forum.xda-developers.com/showthread.php?t=2190753 before creating an issue.
