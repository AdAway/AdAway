...
//        this.binding.bar.replaceMenu(R.menu.next_actions);
    ...
    private void notifyAdBlocked(boolean adBlocked) {
        int color = adBlocked ? MaterialColors.getColor(this, android.R.attr.colorPrimaryDark, Color.RED)
                : MaterialColors.getColor(this, android.R.attr.colorError, Color.GRAY);
